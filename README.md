...
### Usage
You can plug the dongle into the serial or parallel port of any Amiga at any time. Some of the leds will light up if the power pins are providing voltage and current. In particular:
